...
图~\ref{fig:confusion} 展示了两种模型在验证集上的混淆矩阵对比。

\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{confusion_matrix_SEResNet18.png}
        \caption{SE-ResNet18}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{confusion_matrix_SEResNet34.png}
        \caption{SE-ResNet34}
